...
ADD trend_app_protect-4.4.6.jar /usr/local/tomcat/trend_app_protect-4.4.6.jar
ADD trend_app_protect.properties /usr/local/tomcat/trend_app_protect.properties
